...
const FAQPage = (props) => {
  return (
    <Fragment>
      <NextSeo title="FAQ" titleTemplate='%s | Stats-Coronavirus' />
      <FAQPageJsonLd
        mainEntity={ [
          {
            questionName: 'Who? Why? How?',
            acceptedAnswerText: `The Novel Coronavirus (COVID-19) is not related to or a form of the flu (Influenza), it is part of the family of Coronaviruses which includes MERS and SARS.
          ...
          {
            questionName: 'What Do The Terms Confirmed mean?',
            acceptedAnswerText: 'The number of confirmed (recorded) cases.',
          },
          {
            questionName: 'What Do The Terms Deaths mean?',
            acceptedAnswerText: 'The number of confirmed cases that have died.',
          },
          {
            questionName: 'What Do The Terms Recovered mean?',
            acceptedAnswerText: 'The number of confirmed cases that have recovered.',
          },
          {
            questionName: 'What Do The Terms Fatality mean?',
            acceptedAnswerText: 'Sometimes called case fatality risk — is the proportion of deaths compared to the total number of confirmed.',
          },
        ] }
      />
